...
public class AddStudent extends javax.swing.JFrame {
   ...
   public String generateEmail(String firstName, String lastName) {
    ...
    public String[] getStudentData() throws Exception {
       ...
       dateOfAdmission = formatDateOfBirth(dateOfAdmissionChooser.getDate());
       
       

       String[] studentData = {CMSId,password,Department,firstName, lastName,gender, CNIC, dateOfBirth, Email, contact_no, Address, City, Province, Semester, Term, Section, dateOfAdmission};
        return studentData;
    }
    ...
    if (year2 < 2023) {
        JOptionPane.showMessageDialog(null, "Year should be greater than or equal to 2023 for date of addmission.", "Error", JOptionPane.ERROR_MESSAGE);
        ...
        String studentQuery = "INSERT INTO Students (id, semester, date_of_admission) VALUES (?, ?, ?)";
        pst = con.prepareStatement(studentQuery);
        pst.setString(1, studentData[0]); // CMSId
        pst.setInt(2, Integer.parseInt(studentData[13])); // Semester
        pst.setString(3, studentData[16]); // DateOfAdmission
        pst.executeUpdate();
        System.out.println("Data successfully added in Students");

        // Fetch course IDs from Sections
        String sectionQuery = "SELECT course_id FROM Sections WHERE year = ? AND term = ? AND dept_id = ? AND semester = ? AND id = ?";
        pst = con.prepareStatement(sectionQuery);
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date date = dateFormat.parse(studentData[16]);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        int year = calendar.get(Calendar.YEAR);
        pst.setInt(1, year); // Year
        pst.setString(2, studentData[14]); // Term
        pst.setString(3, studentData[2]); // Department ID
        pst.setString(4, studentData[13]); // Semester
        pst.setString(5, studentData[15]); // Section ID
        rs = pst.executeQuery();

        // If no data found in ResultSet, rollback and show error
        if (!rs.next()) {
            con.rollback();
            successlabel.setText("Error:Rollback occurred.");
            System.out.println("rollback");
            return flag;
        } else {
            System.out.println("Fetched courses from sections:");
            ...
            do {
                ...
                String enrolledQuery = "INSERT INTO Enrolled (cms_id, section_id, course_id, semester, term, year) VALUES (?, ?, ?, ?, ?, ?)";
                pst = con.prepareStatement(enrolledQuery);
                pst.setString(1, studentData[0]); // CMSId
                pst.setString(2, studentData[15]); // Section ID
                pst.setString(3, courseId); // Course ID
                pst.setInt(4, Integer.parseInt(studentData[13])); // Semester
                pst.setString(5, studentData[14]); // Term
                pst.setInt(6, year); // Year
                pst.executeUpdate();
                ...
                System.out.println("Data successfully added in Enrolled for course ID: " + courseId);
                
                
                
                
                 String enrolledQuery1 = "INSERT INTO grading (cms_id, section_id, course_id, semester, term, year) VALUES (?, ?, ?, ?, ?, ?)";
                 pst = con.prepareStatement(enrolledQuery1);
                pst.setString(1, studentData[0]); // CMSId
                pst.setString(2, studentData[15]); // Section ID
                pst.setString(3, courseId); // Course ID
                pst.setInt(4, Integer.parseInt(studentData[13])); // Semester
...
// public void addStudent(String[] studentData) throws Exception {
//    String URL = "jdbc:mysql://localhost:3306/cms";
//    String USERNAME = "root";
//    String PASSWORD = "root";
//    Connection con = null;
...
//        
//        // Insert into Personal_Info table
//         if (checkExistingValues(studentData[0],studentData[8],studentData[9],studentData[6])) {
//    successlabel.setText("ID, Email, Contact, or CNIC already exists. Please provide different values.");
//} else {
...
//        pst = con.prepareStatement(personalInfoQuery);
//        pst.setString(1, studentData[0]); // CMSId
//        pst.setString(2, studentData[2]); // Department ID (replace with actual dept_id)
//        pst.setString(3, studentData[3]); // FirstName
//        pst.setString(4, studentData[4]); // LastName
//        pst.setString(5, studentData[5]); // Gender
//        pst.setString(6, studentData[6]); // CNIC
...
//        pst.setString(12, studentData[12]); // Province
//        pst.executeUpdate();
//         System.out.println("Data successfully added in personalinfo");
//
//        
//        
//        // Insert into Login table
//        String insertLoginQuery = "INSERT INTO Login (id, pass, role) VALUES (?, ?, ?)";
//        pst = (PreparedStatement) con.prepareStatement(insertLoginQuery);
//        pst.setString(1, studentData[0]); // CMSId
//        pst.setString(2, studentData[1]); // Password
//        pst.setString(3, "student"); // Assuming default role is "student"
//        pst.executeUpdate();
//        System.out.println("Data successfully added in login");
//
//        
...
//    System.out.println(studentData[14]+ "Term");
//     System.out.println(studentData[2]+ "Departmentid");
//      System.out.println(studentData[13]+ "Semester");
//       System.out.println(studentData[15]+ "Section id");
//   rs = pst.executeQuery();
//  if (!rs.next()) {
//            con.rollback();
//            successlabel.setText("Error:Rollback occurred.");
...
//    
//    
//     successlabel.setText("Data Saved Succesfully");
//     clearFields();
//}
//
//        
...
//}
    ...
    private void initComponents() {
        ...
        city.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
        ...
        contact.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
        ...
        jLabel17.setForeground(new java.awt.Color(7, 10, 82));
        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Semester:");

        semester.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Semeter", "1", "2" }));

        jLabel18.setBackground(new java.awt.Color(255, 255, 255));
        jLabel18.setFont(new java.awt.Font("Dubai", 1, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(7, 10, 82));
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel18.setText("Term:");

        term.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Term", "Spring ", "Fall" }));
        ...
        jLabel20.setForeground(new java.awt.Color(7, 10, 82));
        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Section:");

        section.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Section", "A", "B" }));
        ...
        address.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(section, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(79, 79, 79)
                            .addComponent(semester, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void back4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_back4ActionPerformed
       String[] data;
        try {
            data = getStudentData();
             boolean sucess = addStudent(data);
             if(sucess){
           successlabel.setText("Data added succesfully");}
             else{
             successlabel.setText("some erorr!");
             }
        } catch (Exception ex) {
    ...
    private void cmsidMouseClicked(java.awt.event.MouseEvent evt) {                                   
        successlabel.setText("");
    }
    /**
